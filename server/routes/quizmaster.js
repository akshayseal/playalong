...
// Local disk storage for question images. In production, point this at
// S3/Cloud Storage instead (swap `storage` below) so 1000 players load
// images from a CDN, not from your Node process.
...
router.post('/quizzes', async (req, res) => {
  ...
  const result = await db.query(
    'INSERT INTO quizzes (quizmaster_id, title) VALUES ($1, $2) RETURNING *',
    [req.auth.id, title]
  );
